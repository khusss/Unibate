		...
		<div class="container">
				<div class="row" align="center">
					...
					<div class="panel panel-info">
  						...
  						<div class="panel-heading"><b><font size="4">자유 게시 판</font></b></div>
  						<form action="f_board_write_ok.do" method="post" enctype="multipart/form-data">
  						<table class="table">
  							<tbody>
  								<tr>
  									<td width="10%">제목</td>
  									<td width="90%">
  									<input type="text"  name="fboard_subject" class="form-control" placeholder="제목을 입력해주세요." aria-describedby="basic-addon2"></td>
  								</tr>
  								<tr height="600">
  									<td>내용</td>
  									<td >
  										<textarea rows="30" cols="" name="fboard_content" placeholder="내용을 입력해주세요."  style="resize: none; width:100%;height:100%;border:1;">
  										</textarea>
  									</td>
  								</tr>
  								<tr>
  									<td>YoutubeURL</td>
  									<td>
  									<input type="text"  name="urldata" class="form-control" placeholder="URL을 입력해주세요." aria-describedby="basic-addon2"></td>
  								</tr>
  								<tr>
  									<td colspan="2" align="center">
										...
										<button type="button" class="btn btn-default btn-lg" onclick="location.href='suggestion.do?pageNum=${pageNum}'">
														목록
										</button>
