		...
		<div class="container">
			<div class="row">
				...
				<table class="table">
					<thead >
						<tr >
						<th colspan="3" style="font-family: 'Jeju Gothic', serif; font-size: xx-large;">2017년 7월 최고의 토론</b></th>
						</tr>
					</thead>
				<tbody style="font-family: 'Nanum Gothic', serif;">
				<tr>
					<td style="font-family: 'Jeju Gothic', serif;">날짜</td>
					<td colspan="2">${best_result.start_date} ~ ${best_result.end_date}</td>
				</tr>
				<tr>
					<td style="font-family: 'Jeju Gothic', serif;">주제</td>
					<td colspan="2">${best_result.d_subject}</td>
				</tr>
				<tr>
					<td style="font-family: 'Jeju Gothic', serif;">참여자수</td>
					<td align="center"><b>${mem_num}</b>명</td>
					<c:if test="${best_result.agree_score > best_result.disagree_score}">
					<td style="font-family: 'Jeju Gothic', serif; font-size:large;">찬성 승리</td>
					</c:if>
					<c:if test="${best_result.agree_score < best_result.disagree_score}">
					<td style="font-family: 'Jeju Gothic', serif; font-size: large;">반대 승리</td>
					</c:if>
				</tr>
				...
				<div id="real_center">
								...
								<table height="250px" align="center">
									<tr align="center">
										<td align="center">
										<button style="width: 100px; height: 60px;" class="btn btn-default">이동</button></td>
									</tr>
								</table>
