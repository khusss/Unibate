		...
		<div class="container">
				<div class="row" align="center">
					...
					<div class="panel panel-info">
  						...
  						<div class="panel-heading"><b><font size="4">동아리모집</font></b></div>
  						<form action="recruit_write_ok.do" method="post" enctype="multipart/form-data">
  						<table class="table">
  							<tbody>
  								<tr>
  									<td width="10%">제목</td>
  									<td width="90%">
  									<input type="text"  name="recruit_subject" class="form-control" placeholder="제목을 입력해주세요." aria-describedby="basic-addon2"></td>
  								</tr>
  								<tr height="600">
  									<td>내용</td>
  									<td >
  										<textarea rows="30" cols="" name="recruit_content" placeholder="내용을 입력해주세요."  style="resize: none; width:100%;height:100%;border:1;">
  										</textarea>
  									</td>
  								</tr>
  								<tr>
