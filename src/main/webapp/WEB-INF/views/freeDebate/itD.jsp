									...
									<div class="container">
										<table class="table">
											...
											<c:forEach items="${ad_board_list}" var="x">
												...
												<td><a href="/unibate/reply_view.do?ad_board_num=${x.ad_board_num}&pageNum=${pageNum}&board_group_num=${board_group_num}">${x.ad_subject}</a></td>
												<td>${x.board_date}</td>
												<td>${x.board_count}</td>
												</tr>
											</c:forEach>	
