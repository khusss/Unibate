		...
		<div class="container">
				<div class="row" align="center">
					...
					<div class="panel panel-primary">
  						...
  						<div class="panel-heading"><b><font size="4">토론 주제 건의</font></b></div>
  						<form action="suggestion_write_ok.do" method="post">
  						<table class="table">
  							<tbody>
  								<tr>
  									<td width="10%">제목</td>
  									<td width="90%">
  									<input type="text"  name="suggestion_subject" class="form-control" placeholder="제목을 입력해주세요." aria-describedby="basic-addon2"></td>
  								</tr>
  								<tr height="600">
  									<td>내용</td>
  									<td >
  										<textarea rows="30" cols="" name="suggestion_content" placeholder="내용을 입력해주세요."  style="resize: none; width:100%;height:100%;border:1;">
  										</textarea>
  									</td>
  								</tr>
  								<tr>
