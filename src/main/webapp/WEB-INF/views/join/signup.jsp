	...
	<div class="col-lg-12">
	 <article class="container">
        <div class="page-header">
          <h1>Unibate <small>회원가입</small></h1>
        </div>
        <div class="col-md-6 col-md-offset-3">
          <form action="member_insert.do" method="post" name="member_insert">
          	<div class="form-group">
              <label for="InputID">아이디</label>
              <input type="text" name="id" id="mem_id" class="form-control" placeholder="아이디">
              <div id="check_id"></div>
            </div>
            <div class="form-group">
              <label for="InputEmail">이메일 주소</label>
              <input type="text" name="email_address" id="email_address" class="form-control"  placeholder="이메일 주소">
            ...
            <div class="form-group">
              ...
              <a href="agreement">이용약관</a>에 동의합니다.
              </div>
            </div>
            <div class="form-group text-center">
              <button type="submit" class="btn btn-primary">회원가입<i class="fa fa-check spaceLeft"></i></button>
