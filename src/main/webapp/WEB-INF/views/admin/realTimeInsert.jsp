...
function sendcheck(){
    	...
    	if(fr.d_content.value == "") {
    	    alert("내용 or URL을 입력해 주세요.");
...
<br>
	...
	<div class="container">
		<div class="row">
		<form action="realtextInsert.do" id="fr"  name="fr" onsubmit='return sendcheck()'>
			<table class="table">
			<tr>
				<td width="20%">토론제목:</td>
				<td><input type="text" id="d_subject" name="d_subject" size="100"></td>
			</tr>
			<tr>
				<td>토론관련내용 or URL:</td>
				<td><input type="text" id="d_content"  name="d_content" size="100"></td>
			</tr>
			<tr>
				<td colspan="2"> <input type="submit" value="작성하기" class="btn btn-default" ></td>
			</tr>
			</table>
		</form>	
		</div>
