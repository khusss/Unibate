									...
									<div class="container" align="center">
										<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
     									   <div class="panel panel-success">
                								...
                								<form id="login-form" action="login_check.do">
                									<img alt="" src="img/Unibate.png" width="25%" height="15%">
                    								<div>
                    								...
                    								<div>
                    									<b><a href="member_form.do" style="color: black;">회원 가입</a></b>&nbsp;&nbsp;/&nbsp;&nbsp;<b><a href="member_find.do" style="color: black;">ID, 비밀번호 찾기</a></b>
