				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="portfolio-categ filter">
							<li class="it"><a href="/unibate/free_Board_List.do?board_group_num=11&pageNum=1">IT/과학</a></li>
							<li class="social"><a href="/unibate/free_Board_List.do?board_group_num=12&pageNum=1" title="">사회/정치</a></li>
							<li class="literature"><a href="/unibate/free_Board_List.do?board_group_num=13&pageNum=1" title="">문학</a></li>
							<li class="edu"><a href="/unibate/free_Board_List.do?board_group_num=14&pageNum=1" title="">교육</a></li>
							<li class="philosophy"><a href="/unibate/free_Board_List.do?board_group_num=15&pageNum=1" title="">철학</a></li>
							<li class="sport"><a href="/unibate/free_Board_List.do?board_group_num=16&pageNum=1" title="">스포츠</a></li>
							<li class="environment"><a href="/unibate/free_Board_List.do?board_group_num=17&pageNum=1" title="">환경</a></li>
						</ul>
									...
									<div class="container">
										<table class="table">
											...
											<c:forEach items="${ad_board_list}" var="x">
												...
												<td><a href="/unibate/reply_view.do?ad_board_num=${x.ad_board_num}&pageNum=${pageNum}&board_group_num=${x.board_group_num}">${x.ad_subject}</a></td>
												<td>${x.board_date}</td>
												<td>${x.board_count}</td>
												</tr>
											</c:forEach>	
