			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="big-cta">
							<div class="cta-text">
								<h2><span><font size="20">Q</font></span> & A</h2>
							</div>
						</div>
						<div class="clearfix">
						</div>
								...
								<ul id="thumbs" class="portfolio">
									<div class="container">
										<table class="table">
											...
											<tbody>
											<c:set var="number" value="${allQNA-(pageNum-1)*15}" />
											<c:forEach items="${qboard}" var="qb">
												<tr>
													<td>${number}</td>
													<th scope="row"><a href="qnaView.do?pageNum=${pageNum}&qna_num=${qb.qna_num}">${qb.qna_subject }</a></th>
													<td>${qb.id}</td>
													<td>${qb.qna_date}</td>
												</tr>
										...
										<div class="text-center">
											<ul class="pagination pagination-large">
												...
												<c:if test="${pageCount >= pageNum+10 and pageCount > 10}">
													<li><a href="qna.do?pageNum=${pageNum+10}">Next</a></li>
												</c:if>
												<c:if test="${pageCount < pageNum+10 and pageCount > 10}">
													<li><a href="qna.do?pageNum=${pageCount}">Next</a></li>
												</c:if>
