...
function update(){
        var confirmflag = confirm("토론결과를 업데이트 하시겠습니까?!");
        
        if(confirmflag){
           location.href='realtimeResult.do'
...
<br>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
			<div class="col-lg-4">
				<button type="button" class="btn btn-default" onclick="location.href='realtimeInsert.do'">실시간 토론 게시 글 관리</button>
			</div>
			<div class="col-lg-4">
				<button type="button" class="btn btn-primary" onclick="update()">토론 결과 뷰 관리</button>
			</div>
			<div class="col-lg-4">
				<button type="button" class="btn btn-info" onclick="location.href='realtimeBest.do'">최고의 토론 뷰 관리</button>
			</div>
			</div>
		</div>
		<br>
