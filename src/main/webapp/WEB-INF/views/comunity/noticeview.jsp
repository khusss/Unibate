					 	...
					 	<tr>
					 		<td colspan="2">
					 			<c:if test="${noticeboard.notice_board_num<noticesum}">
  								<a href="noticeView.do?pageNum=${pageNum}&notice_num=${noticeboard.notice_board_num+1}"  style="color: black;">
					 		...
					 		<td rowspan="2">
					 			<button class="btn btn-default" aria-label="Left Align" onclick="location.href='notice.do?pageNum=${pageNum}'">
					 				목록
					 			</button>
					 		</td>
					 	</tr>
